...
class Packet {
public:
    UZUY_NON_COPYABLE(Packet);
    UZUY_NON_MOVEABLE(Packet);
...
class Frame {
public:
    UZUY_NON_COPYABLE(Frame);
    UZUY_NON_MOVEABLE(Frame);
...
class Decoder {
public:
    UZUY_NON_COPYABLE(Decoder);
    UZUY_NON_MOVEABLE(Decoder);
...
class HardwareContext {
public:
    UZUY_NON_COPYABLE(HardwareContext);
    UZUY_NON_MOVEABLE(HardwareContext);
...
class DecoderContext {
public:
    UZUY_NON_COPYABLE(DecoderContext);
    UZUY_NON_MOVEABLE(DecoderContext);
...
class DeinterlaceFilter {
public:
    UZUY_NON_COPYABLE(DeinterlaceFilter);
    UZUY_NON_MOVEABLE(DeinterlaceFilter);
...
class DecodeApi {
public:
    UZUY_NON_COPYABLE(DecodeApi);
    UZUY_NON_MOVEABLE(DecodeApi);
